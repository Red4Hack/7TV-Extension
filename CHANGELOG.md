...
- Fixed duplicate emote replacements in chat input
- Updated chat emotes composable to improve reactivity
- Added emoji vector caching to improve performance
- Added API response caching to reduce network requests
